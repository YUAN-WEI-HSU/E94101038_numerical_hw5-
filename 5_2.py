...
for h in [0.1, 0.05]:
    ...
    print(f"\n===== RK4 結果 (h = {h}) =====")
    print(f"{'t':>5} | {'u1_RK4':>12} | {'u1_exact':>12} | {'err_u1':>10} || {'u2_RK4':>12} | {'u2_exact':>12} | {'err_u2':>10}")
    print("-"*90)
    for t, num, ex, err in zip(t_values, u_values, exact_values, error):
        print(f"{t:5.2f} | {num[0]:12.8f} | {ex[0]:12.8f} | {err[0]:10.2e} || {num[1]:12.8f} | {ex[1]:12.8f} | {err[1]:10.2e}")
